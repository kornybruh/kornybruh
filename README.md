...
https://sim.kornz.net GOT CHAMPION IN easykid compettion tech start up!()<br>
...
https://box.kornz.net(cleanedup) (acts like dropbox ai style and closed) <br>
https://api.rtaf.net(cleanedup) <br>
https://hwnnotes.kornz.net(RUNS now!) school thigns like summary notes into that<br>
https://hwndreambox.kornz.net(RUNS now!) ahh ticket like school<br>
<br>
feature: <br>
sim.kornz.net, <br>
hwnnotes.kornz.net, <br>
hwndreambox.kornz.net, <br>
fininfo.rtaf.net, <br>
homemaster.rtaf.net, <br>
homefts.rtaf.net <br>
<br>
all works that in thsi list is private repos acts like backup <br>
highly thank claudecode,antigravity,kilo,kimicode for making websites and eating my moeny <br>
all the point IS to understand the layout,specs,codebase,datatable before telling ai to do it <br>
basicly you need a low to mid knows about web structure,server,full stack like <br>
<br>
thank cloudflare <br>
<br>
